 ...
 * generated in the net.moz.customerservice.web package. 
...
public class ObjectFactory {
    ...
    private final static QName _CustomerById_QNAME = new QName("http://web.customerservice.moz.net/", "customerById");
    private final static QName _CustomerByIdResponse_QNAME = new QName("http://web.customerservice.moz.net/", "customerByIdResponse");
    private final static QName _CustomerList_QNAME = new QName("http://web.customerservice.moz.net/", "customerList");
    private final static QName _CustomerListResponse_QNAME = new QName("http://web.customerservice.moz.net/", "customerListResponse");
    private final static QName _SaveCustomer_QNAME = new QName("http://web.customerservice.moz.net/", "saveCustomer");
    private final static QName _SaveCustomerResponse_QNAME = new QName("http://web.customerservice.moz.net/", "saveCustomerResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: net.moz.customerservice.web
     * 
     */
     ...
     */
    @XmlElementDecl(namespace = "http://web.customerservice.moz.net/", name = "customerById")
     ...
     */
    @XmlElementDecl(namespace = "http://web.customerservice.moz.net/", name = "customerByIdResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://web.customerservice.moz.net/", name = "customerList")
     ...
     */
    @XmlElementDecl(namespace = "http://web.customerservice.moz.net/", name = "customerListResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://web.customerservice.moz.net/", name = "saveCustomer")
     ...
     */
    @XmlElementDecl(namespace = "http://web.customerservice.moz.net/", name = "saveCustomerResponse")
