package net.moz.accountservice.web;

import net.devh.boot.grpc.client.inject.GrpcClient;
import net.moz.accountservice.feign.CustomerRestClient;
import net.moz.accountservice.mappers.CustomerMapper;
...
import net.moz.customerservice.web.CustomerById;
import net.moz.customerservice.web.CustomerSoapService;
...
public class AccountRestController {
    ...
    public List<Customer> soapCustomers(){
        List<net.moz.customerservice.web.Customer> soapCustomers = customerSoapService.customerList();
    ...
    public Customer customerByIdSoap(@PathVariable Long id){
        net.moz.customerservice.web.Customer soapCustomer = customerSoapService.customerById(id);
